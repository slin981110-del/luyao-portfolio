...
- Mobile adaptation is now explicitly approved. Preserve the desktop composition unchanged, while using a compact fixed header, a complete works-category menu, single-column reading flow, touch-sized controls, and simplified mobile presentation for the video archive, poster gallery, longform Stack, AI carousel, lightboxes, and contact finale.
